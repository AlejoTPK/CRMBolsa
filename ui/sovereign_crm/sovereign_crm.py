...
from .insights_components import (
    quick_alert_card,
    ...
    return rx.vstack(
        ...
        rx.hstack(
            rx.vstack(
                ...
                rx.text(
                    "Monitor global de activos. Última actualización: Auto.",
        ...
        rx.grid(
            kpi_card(
                "Oro (XAU/USD)",
                AppState.gold_price_fmt,
                AppState.gold_change_fmt,
                AppState.gold_is_positive,
                AppState.gold_status,
                AppState.gold_sparkline_fig,
            ),
            kpi_card(
                "Petróleo Crudo (WTI)",
                AppState.oil_price_fmt,
                AppState.oil_change_fmt,
                AppState.oil_is_positive,
                AppState.oil_status,
                AppState.oil_sparkline_fig,
            ),
            columns="2",
            spacing="6",
            width="100%",
        ...
        rx.tabs.root(
            rx.tabs.list(
                rx.tabs.trigger(
                    rx.hstack(rx.icon("coins", size=16), rx.text("Oro (XAU/USD)")),
                    value="oro",
                ),
                rx.tabs.trigger(
                    rx.hstack(rx.icon("droplet", size=16), rx.text("Petróleo (WTI)")),
                    value="petroleo",
                ),
                size="2",
                width="100%",
            ...
            rx.tabs.content(
                rx.vstack(
                    candlestick_chart(
                        "PETRÓLEO — WTI", "WTI", AppState.oil_candlestick_fig, "#B0C4DE"
                    ),
                    rx.box(
    ...
    return rx.vstack(
        ...
        rx.hstack(
            rx.vstack(
                ...
                rx.text(
                    "Reportes de inteligencia de mercado en tiempo real.",
                    color=COLORS["text_muted"],
                    size="2",
                ),
                align_items="start",
...
def portafolio_view() -> rx.Component:
    ...
    return rx.vstack(
        ...
        rx.hstack(
            ...
            rx.box(
                rx.plotly(
                    data=AppState.portfolio_distribution_fig,
                    height="250px",
                    width="400px",
        ...
        rx.grid(
            glass_card(
                rx.vstack(
                    ...
                    rx.hstack(
                        rx.text(
                            f"{AppState.portfolio_gold_oz} oz",
                            color=COLORS["text_muted"],
                        ),
                        rx.spacer(),
                        rx.text(
                            AppState.portfolio_gold_fmt,
                            color="#D4AF37",
                            font_size="1.8rem",
                            font_weight="bold",
                            font_family="serif",
            ...
            glass_card(
                rx.vstack(
                    ...
                    rx.hstack(
                        rx.text(
                            f"{AppState.portfolio_oil_bbl} barriles",
                            color=COLORS["text_muted"],
                        ),
                        rx.spacer(),
                        rx.text(
                            AppState.portfolio_oil_fmt,
                            color="#B0C4DE",
                            font_size="1.8rem",
                            font_weight="bold",
                            font_family="serif",
...
app.add_page(
    ...
    on_load=[
        AppState.fetch_market_quotes,
        AppState.listen_market_ws,
        InsightsState.fetch_latest_alert,
        InsightsState.fetch_history,
    ],
)
